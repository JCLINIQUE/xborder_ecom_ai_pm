...
| 第二周 · Day 08–14 | 用户试用；从模型能力认识产品形态与人机协作；制作学习 PWA，练习正常与异常交互并补充同一份 PRD |
...
[Day 09 · AI 基础①：从模型能力到产品形态](index.html#day-09) 以“为什么同样是 AI，用起来却不一样”为主问题。保留模型能力、训练与推理、上下文和输出局限的基础讲解，再围绕同一个运营日报任务，重点比较 NotebookLM 的资料研究、Lovart 的成果共创、Claude Cowork 的任务委派与 n8n 的流程编排。学员用“如何表达意图、围绕什么工作、谁决定下一步、何时触发与持续多久”四个问题比较产品，区分 AI-native、交互方式与自主程度，并解释工作台的形态选择。当天先看懂差异，Day 11–12 练具体交互，Day 15–17 再解释执行架构。

学员将 Day 09 的判断整理为同一组 **3–5 张基础与产品对比卡**，每张包含解释、运营例子、来源及核对日期、自测题与解析，至少一张对比两种形态并说明工作台选择理由。Day 10 沿用这些卡片亲手制作学习 PWA，在手机上复习并自测。主项目 Demo、学习 PWA 和最终项目材料会在课程中逐步完成；当前仓库提供教学安排及下列配套教材。
