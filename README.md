...
| 阶段 | 主要内容 |
| --- | --- |
| 第一周 · Day 01–07 | Day 01–03：调研 → 候选需求提炼 → 功能推导与业务版 PRD；Day 04–07 保留旧安排，待衔接 |
...
Day 01–03 聚焦**日常竞品跟踪如何辅助运营决策**。Day 01 先区分产品开发／选品的市场调研与运营的日常跟踪，再示范访谈和报告；Day 02 从核验、比较与判断中提出 2–3 条候选需求，标明证据缺口并推荐一项；Day 03 先浏览完整 PRD 框架，再从一条价格／促销跟踪需求推导功能，参照同一方案的示例写成业务版 PRD 初稿。

现有材料提供了跟踪流程和判断思路，完整的连续记录与真实处理案例仍待补充。课堂模拟样例单独标注，不作为已验证的需求或收益；桌麦市场报告归入市场调研参考，不与跟踪证据混用。

业务版是同一份 PRD 的第一版，先写清业务行为与验收，再随学习补充 AI 交互、架构、数据和评测。**Day 04–30 及后续阶段目标目前保留旧安排，待按新 PRD 示例衔接。** 旧原型仍为 SSD 教学示例，待与当前 Day 03 的 F1–F4 衔接。
