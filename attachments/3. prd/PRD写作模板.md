...
课堂主线是“一款自家商品＋少量已选竞品 → 资料整理与文字图片提取 → 竞品对照 → 带依据的卖点建议 → 运营修改确认”。需求与首版功能明确后，再把它们写成 PRD；不预设必须沿用旧版 R1–R4 或“录入—比较—导出”方案。[旧版 SSD PRD](<业务版PRD-竞品对比助手.md>) 仅用于参考规则和验收的写法，不是当前 Day 03 的产出。
