...
尚未理解或确定的 AI 方案登记为“待学习后补 / 待审查”；项目不采用的能力标为“不涉及”并说明原因。Day 09–11 学习 AI 概念、交互范式与现有技术架构后，补充产品机制、交互规则和技术取舍；Day 12 对照 PRD、原型与 Demo 评审一致性，Day 13–14 补充文档并定向修订。Day 15–18 学习离线评测并完成对照改进后，更新质量要求、验收与版本记录；Day 19 完善发布协作要求，Day 22–23 补充适用的实验设计与结果判断。各章中的完整交付要求及第 18 节自检按项目适用范围使用，不作为第一周的全量作业标准。
