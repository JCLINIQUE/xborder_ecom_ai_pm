...
与后续 AI 方案有关的内容先登记为“待学习后补”，学到相关知识并确定项目方案后再填写；项目不采用的能力标为“不涉及”并说明原因。Day 11–14 学习评测后补相关质量要求，Day 17–18 学习选型与协作后完善相关方案与交付要求。各章中的完整交付要求及第 18 节自检按项目适用范围使用，不作为第一周的全量作业标准。
